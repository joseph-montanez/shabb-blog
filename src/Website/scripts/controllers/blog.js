...
angular.module('spa2App').factory('BlogPages', ['$resource',
	function($resource){
	    return $resource('//192.168.2.7:8083/blog/posts/page/:PageNo', {}, {
			query: {method:'GET', params:{PageNo:'0'}}
		});
	}]);

angular.module('spa2App').factory('BlogEntry', ['$resource',
	function($resource){
		return $resource('../api/blog/entry/:EntryID', {}, {
